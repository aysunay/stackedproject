...
import 'remove_technician_dialog_model.dart';

const double _graphicSize = 60;

class RemoveTechnicianDialog extends StackedView<RemoveTechnicianDialogModel> {
  final DialogRequest request;
  final Function(DialogResponse) completer;

  const RemoveTechnicianDialog({
    Key? key,
  ...
  Widget builder(
    ...
    RemoveTechnicianDialogModel viewModel,
    Widget? child,
  ) {
    return Dialog(
