...
class CardListView extends StackedView<CardListViewModel> {
  ...
  @override
  Widget builder(BuildContext context, CardListViewModel model, Widget? child) {
    return ViewModelBuilder<CardListViewModel>.reactive(
      ...
      builder: (context, model, child) {
        return Scaffold(
          ...
          body: StreamBuilder<List<OnTimeCardModel>>(
            stream: model.cards,
                  ...
                  builder: (context) {
                    ...
                    if (snapshot.hasError) {
                      return ListView(
                        ...
                        children: const [
                          ...
                          Center(
                              child: Text(
                                  "Bağlantı hatası. Yukarı kaydırarak tekrar deneyin.")),
                        ],
                      );
                    }
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final fullCode =
                            "${card.cardBarcode ?? ''}*${card.cardId ?? ''}";
                        final copyText =
                            fullCode.replaceFirst(RegExp(r'^W'), '');
                                ...
                                Positioned(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: model
                                          .getStatusColor(card.cardStatus)
                                          .withOpacity(0.8),
                                    ...
                                    child: Text(
                                      ...
                                      style: TextStyle(
                                        color: model.getStatusTextColor(card.cardStatus),
                                        fontWeight: FontWeight.bold,
                                        fontSize: 12,
                                        letterSpacing: 1.1,
                                      ),
