...
class MyTeamViewModel extends ReactiveViewModel {
  ...
  // @override
  // Future futureToRun() {
  //   loadTeam("facility123");
  // }

  // bool get isConnected => _signalRService.connectionState == HubConnectionState.connected;
  //
  ...
  //   try {
  //     final newTech = await runBusyFuture(_teamApiService.addTechnician(name: name, role: role));
  ...
  //   try {
  //     final team = await runBusyFuture(_teamApiService.getTechnicians(facilityId));
  //     _technicians.clear();
